...
function bearsmith_enqueue_styles_and_scripts() {
    ...
    wp_register_script( 'micromodal', 'https://unpkg.com/micromodal/dist/micromodal.min.js' );
    ...
    wp_enqueue_script( 'custom-plugins', get_stylesheet_directory_uri() . '/js/plugins.js', array( 'jquery.3.4.1',  'micromodal' ), $script_last_updated_at, true );
    wp_enqueue_script( 'custom-site', get_stylesheet_directory_uri() . '/js/site.js', array( 'jquery.3.4.1', 'micromodal' ), $script_last_updated_at, true );
}
